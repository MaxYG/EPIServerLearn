...
using EpiserverSiteForSearch.Business;
using EpiserverSiteForSearch.Business.Rendering;
using EpiserverSiteForSearch.Models.Pages;
using EpiserverSiteForSearch.Models.ViewModels;
using EPiServer.Web;
using EPiServer.Web.Mvc;
using EPiServer;

namespace EpiserverSiteForSearch.Controllers
{
